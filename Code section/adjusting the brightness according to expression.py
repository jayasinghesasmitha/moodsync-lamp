...
def analyze_facial_movement(duration=20):
    ...
    # Create directory to save analysis frames
        ...
        if results.multi_face_landmarks:
            ...
            if frame_count % 5 == 0:
                try:
                    ...
                    # Adjust screen brightness based on emotion
                    if dominant_emotion in ['happy', 'surprise']:
                        sbc.set_brightness(100)  # Bright for positive emotions
                    elif dominant_emotion in ['sad', 'fear', 'angry']:
                        sbc.set_brightness(30)  # Dim for negative emotions
                    else:
                        sbc.set_brightness(70)  # Neutral brightness
    ...
    sbc.set_brightness(70)  # Reset brightness to neutral
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            print("Installing screen_brightness_control...")
            import subprocess
            subprocess.run(["pip", "install", "screen-brightness-control"], check=True)
